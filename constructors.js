...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  // name, age, email, and savedPosts in that order. Name and email will be strings, age will be a 
  // number and savedPosts will be an array of objects. These objects will each have 3 properties: 
  ...
  // Name this method addSavedPost. It should take in three parameters: 
  ...
  User.prototype.addSavedPost = function(id, title, rating){
      ...
      // this.savedPosts.push(this.addSavedPost) 
  }
